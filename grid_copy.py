...
class Grid:
    ...
    def __str__(self):
        ...
        lst = []
        invmap = [list(i) for i in zip(*self.map)]
        for i in invmap:
            lst.append("".join(i))
        return"\n".join(lst)
    ...
    def find_path(self, start_node, target_node):
        ...
        while not opens.is_empty():
            ...
            if q.grid_y-1 >= 0 and q.grid_y - 1 < self.height and q.grid_x-1 >= 0 and q.grid_x - 1 < self.width and g[q.grid_x-1][q.grid_y-1] != "+":
                suc.append(Node(g[q.grid_x-1][q.grid_y-1] != "+",q.grid_x-1,q.grid_y-1))
            if q.grid_y-1 >= 0 and q.grid_y - 1 < self.height and q.grid_x >= 0 and q.grid_x < self.width and g[q.grid_x][q.grid_y-1] != "+":
                suc.append(Node(g[q.grid_x][q.grid_y-1] != "+",q.grid_x,q.grid_y-1))
            if q.grid_y-1 >= 0 and q.grid_y - 1 < self.height and q.grid_x + 1 >= 0 and q.grid_x + 1 < self.width and g[q.grid_x+1][q.grid_y-1] != "+":
                suc.append(Node(g[q.grid_x+1][q.grid_y-1] != "+",q.grid_x+1,q.grid_y-1))
            if q.grid_y >= 0 and q.grid_y < self.height and q.grid_x-1 >= 0 and q.grid_x - 1 < self.width and g[q.grid_x-1][q.grid_y] != "+":
                suc.append(Node(g[q.grid_x-1][q.grid_y] != "+",q.grid_x-1,q.grid_y))
            if q.grid_y >= 0 and q.grid_y < self.height and q.grid_x+1 >= 0 and q.grid_x + 1 < self.width and g[q.grid_x+1][q.grid_y] != "+":
                suc.append(Node(g[q.grid_x+1][q.grid_y] != "+",q.grid_x+1,q.grid_y))
            if q.grid_y+1 >= 0 and q.grid_y + 1 < self.height and q.grid_x-1 >= 0 and q.grid_x - 1 < self.width and g[q.grid_x-1][q.grid_y+1] != "+":
                suc.append(Node(g[q.grid_x-1][q.grid_y+1] != "+",q.grid_x-1,q.grid_y+1))
    ...
    def plot_path(self, start_node, target_node):
        ...
        for p in paths:
            if p != start_node and p!= target_node:
                g[p.grid_x][p.grid_y] = "*"
        #join the grid back up and return the new grid
        inv = [list(i) for i in zip(*self.map)]
        new = []
